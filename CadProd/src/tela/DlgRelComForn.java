 ...
 * @author pretto
 */
public class DlgRelComForn extends javax.swing.JDialog {

    /**
     * Creates new form DlgRelOS
     */
    public DlgRelComForn(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Relatório de Compras por Fornecedor");
        ...
        jLabel1.setText("Relatório de Compras por Fornecedor");
    ...
    private void btnGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarActionPerformed
        ...
        try {
            // Compila o relatorio
            JasperReport relatorio = JasperCompileManager.compileReport(getClass().getResourceAsStream("/relatorios/rel_compra_forn.jrxml"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgRelComForn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgRelComForn dialog = new DlgRelComForn(new javax.swing.JFrame(), true);
